...
class ManualFocusNode(Node):
    def __init__(self):
        ...
        self.focus_info_publisher = self.create_publisher(FocusStatus, '/camera/status/focus_info', 10)
